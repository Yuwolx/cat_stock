...
def generate_market_briefing(target_date: str, use_mock_data: bool | None = None) -> dict:
    ...
    payload = {
        ...
        "indices": get_market_indices(target_date, use_mock_data=effective_mock_data),
        "global_macro": get_global_macro_snapshot(target_date, use_mock_data=effective_mock_data),
        "leaders": get_trading_value_leaders(target_date, use_mock_data=effective_mock_data),
        "investor_flows": get_investor_flows(target_date, use_mock_data=effective_mock_data),
        "derivatives": get_derivatives_snapshot(target_date, use_mock_data=effective_mock_data),
        "market_events": get_market_event_lists(target_date, use_mock_data=effective_mock_data),
